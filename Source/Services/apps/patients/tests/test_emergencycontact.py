...
class TestEmergencyContactUsingPatient(PatientsMixin, APITestCase):
    """
    Test cases for :model:`patients.EmergencyContact` using a patient
...
class TestEmergencyContactUsingEmployee(PatientsMixin, APITestCase):
    """
    Test cases for :model:`patients.EmergencyContact` using an employee
    as the logged in user.
    """
